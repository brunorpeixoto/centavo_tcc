...
import 'package:centavo_tcc/screens/filter/components/section_title.dart';
  ...
  Widget build(BuildContext context) {
    Widget buildOption(String title, OrderBy option) {
      return GestureDetector(
        onTap: () {
          filter.serOrderBy(OrderBy.DATE);
        },
        child: Container(
          height: 50,
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color:
                  filter.orderBy == option ? Colors.amberAccent : Colors.grey,
            ),
          ),
          child: Text(
            title,
        ...
        Observer(builder: (_) {
          return Row(
            children: [
              ...
              //buildOption('Preço', OrderBy.DATE),
            ],
          );
        }),
      ],

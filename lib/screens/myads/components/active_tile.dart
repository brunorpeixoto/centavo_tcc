...
import 'package:centavo_tcc/components/dialog_platform.dart';
...
class ActiveTile extends StatelessWidget {
  ...
  final List<MenuChoice> choices = [
    ...
    MenuChoice(index: 1, title: 'Já doei', iconData: Icons.thumb_up),
  ...
  void soldAd(BuildContext context) {
    showDialog(
        ...
        builder: (_) =>
            DialogPlatform(
              title: 'Vendido',
              content: 'Confirmar a doação de \'${ad.title}\'?',
              textNoButton: 'Não',
              textYesButton: 'Sim',

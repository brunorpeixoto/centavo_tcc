...
import 'package:centavo_tcc/components/empty_card.dart';
          ...
          children: [
            Observer(builder: (_) {
              if (store.activeAds.isEmpty)
                return EmptyCard('Você não possui nenhuma doação ativa.');
            ...
            Observer(builder: (_) {
              if (store.pendingAds.isEmpty)
                return EmptyCard('Você não possui nenhuma doação pendente.');
            ...
            Observer(builder: (_) {
              if (store.soldAds.isEmpty)
                return EmptyCard('Você não possui nenhum anúncio doado.');
